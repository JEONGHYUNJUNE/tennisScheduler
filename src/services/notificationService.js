...
const notificationSelectColumns = 'id, type, title, message, event_id, free_opinion_id, free_opinion_comment_id, tennis_event_comment_id, inquiry_id, inquiry_reply_id, actor_member_id, is_read, created_at'
